...
WARN_PATTERNS = [
    (r"\bnpm\s+publish\b", "Publishing from Claude should require an explicit human decision."),
    (r"\bpnpm\s+publish\b", "Publishing from Claude should require an explicit human decision."),
]
