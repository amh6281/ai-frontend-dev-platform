...
> 이 커맨드는 `.claude/rules/code-quality.md` 와 `.claude/rules/typescript.md` 룰을 기준으로
...
- 리팩토링 기준은 반드시 **프로젝트 룰(code-quality.md, typescript.md)** 에 근거한다
...
| 상태             | 판단 기준                                        | 안내 메시지                          |
| ---------------- | ------------------------------------------------ | ------------------------------------ |
| 룰 파일 없음     | `code-quality.md` 와 `typescript.md` 모두 없음 | 리팩토링 기준 룰 파일을 찾을 수 없음 |
...
### code-quality.md 기준 (§2 Code Writing Principles / §3 Performance / §7 Accessibility)
