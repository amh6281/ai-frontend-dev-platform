...
| Claude | `claude/` | `claude/README.md`     | `claude/CLAUDE.md`, `claude/.claude/rules/` |
...
**포함된 규칙:** Cursor의 코드 품질, TypeScript, React, testing, accessibility, LLM 행동 가이드를 Claude용 rule 파일로 옮겨 `claude/.claude/rules/`에 포함합니다.
